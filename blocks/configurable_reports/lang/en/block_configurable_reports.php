...
$string['privacy:metadata:block_configurable_reports:lastexecutiontime'] = 'Time this report took to run last time it was executed,
 ...
 //eAbyas
$string['detailcourseinfo'] = 'Detail Course information';
$string['report_detailcourseinfo'] = 'Detail Course information';
$string['column'] = 'Column';
$string['allcourses'] = 'Courses';
$string['select_option'] = '-- Select --';
$string['selectall_option'] = 'All Courses';
$string['allusers'] = 'Employees';
$string['selectall_employees'] = 'All Employees';
$string['filterallusers_summary'] = 'This Filter shows list of all the Employees. Only one Employee can be selected at a time';
$string['filterallusers'] = 'Employees';
$string['employee'] = 'Employee';
$string['detailclassroominfo'] = 'Detail ILT information';
$string['report_detailclassroominfo'] = 'Detail ILT information';
$string['allclassrooms_option'] = 'All ILTs';
$string['classroom'] = 'ILT';
$string['classrooms'] = 'ILTs';
$string['filterclassrooms'] = 'ILTs filter';
$string['filter_classrooms'] = 'ILT';
$string['filterclassrooms_summary'] = 'This Filter shows list of all the ILTs. Only one ILT can be selected at a time';
$string['not_completed'] = 'Not Completed';
$string['completed'] = 'Completed';
$string['completionstate'] = 'Completion State';
$string['filtercompletionstate_summary'] = 'Completionstate filter with having Completed and Not completed options';
$string['report_onlineexamsinfo'] = 'Online Exams information';
$string['onlineexamsinfo'] = 'Online Exams information';
$string['onlineexams_summary'] = 'This Filter shows list of all the Online Exams. Only one Online Exam can be selected at a time';
$string['onlineexams'] = 'Online Exams';
$string['allonlinetests_option'] = 'All Online Exams';

$string['report_feedbackinfo'] = 'Detail Feedback information';
$string['feedbackinfo'] = 'Detail Feedback information';
$string['feedbackfilter_summary'] = 'This Filter shows list of all the Feedbacks. Only one Feedback can be selected at a time';
$string['feedback'] = 'Feedback';
$string['feedbacks'] = 'Feedbacks';
$string['allfeedbacks_option'] = 'All Feedbacks';

$string['report_programinfo'] = 'Detail Program information';
$string['programinfo'] = 'Detail Program information';
$string['programfilter_summary'] = 'This Filter shows list of all the Programs. Only one Program can be selected at a time';
$string['program'] = 'Program';
$string['programs'] = 'Programs';
$string['allprograms_option'] = 'All Programs';

$string['report_certificationinfo'] = 'Detail Certification information';
$string['certificationinfo'] = 'Detail Certification information';
$string['certificationsfilter_summary'] = 'This Filter shows list of all the Certifications. Only one Certification can be selected at a time';
$string['certification'] = 'Certification';
$string['certifications'] = 'Certifications';
$string['allcertifications_option'] = 'All Certifications';
$string['internal'] = 'Internal';
$string['external'] = 'External';

$string['report_coursesconfiguration']='Courses Configuration Report';
$string['coursesconfiguration_columns']='Courses Configuration Columns';
$string['coursesconfiguration']='Courses Configuration';
$string['report_detailed_course_completion'] = "Detailed Course Completion";
$string['detailedcoursecompletion'] = 'Detailed Course Completion';
$string['detailed_course_completion_field'] = 'Detailed Course Completion';
$string['coursecompletionstatus'] = "Course Completion Status";
$string['empstatus'] = 'Employee Status';
$string['emploeyee_status_summary'] = "Employee Active/Inactive Status filter";
$string['selectallcourses'] = 'Courses';
$string['status_summary'] = "Course Completion Status Filter";
$string['select'] = "Select";
$string['filterdate_summary']='Date Filter';
$string['filterquizcourses'] = 'Quiz courses filter';
$string['quizbycourse'] = 'Quiz by courses report';
$string['report_quizbycourse'] = 'Quiz by courses';
$string['quizbycoursecolumns'] = 'Quiz by course columns';
$string['idp_field'] = 'Individual Learning Plan';
$string['report_idp'] = 'Individual Learning Plan (ILP) Report';
$string['idp'] = 'Individual Learning Plan (ILP) Report';
$string['datefilter']='Date Filter';
$string['date']='Date';
$string['report_mooc_courses'] = "Mooc Coures Report";
$string['mooccourses'] = "Mooc Courses Report Columns";
$string['moocfilter'] = "MOOC or Elearning courses";
$string['courselist'] = "Mooc courses columns";
$string['report_sme_credit_points'] = "SME Credit Points";
$string['smecreditpoints'] = "SME Credit Points Columns";
$string['project_review_viva'] = "Project review and Viva";
$string['classroom_content_development'] = "ILT Content Development";
$string['eLearning_content_development'] = "eLearning Content Development";
$string['classroom_delivery'] = "ILT Delivery";
$string['others'] = "Others";
$string['cpreports']= "Reports";
$string['classroomsummary'] = $string['report_classroom_summary'] = "ILT Summary Report";
$string['trainingfeedbackresponses'] = $string['report_trainingfeedbackresponses'] = "Training Feedback Responses";
$string['trainerfeedbackresponses'] = $string['report_trainerfeedbackresponses'] = "Trainer Feedback Responses";
$string['trainernps'] = $string['report_trainingnps'] = "Trainer NPS";
$string['startenddates']= $string['startenddatefilter'] = "Start and End dates";

$string['lpathoverview'] = $string['report_lpathoverview'] = $string['plugin_lpathoverview'] = "Learning Path Overview";

$string['lpath_completion'] = $string['report_lpath_completion'] = $string['lpathcompletion'] = $string['plugin_lpathcompletion'] = "Learning Path Completions";

$string['learningpaths'] = $string['filterlearningpaths'] = 'Learning Path';
$string['lpathfilter_summary'] = 'Learning Path filter for Learning Path related reports ';
$string['nodirectaccess'] = 'Direct access to this script is forbidden.';
$string['course_certification_field'] = 'Course Certification Field';
$string['report_course_certification'] = 'Course Certification';
$string['coursecertification'] = 'Course Certification';
$string['mooc'] = 'MOOC';
$string['iltcourse'] = 'ILT Course';
$string['active'] = 'Active';
$string['inactive'] = 'In-Active';
$string['visible'] = 'Visible';
$string['invisible'] = 'Invisible';
$string['blended'] = 'Blended';
$string['internal_certification'] = 'Fractal-certified Internal Certification';
$string['external_certification'] = 'External Certification';
$string['filtercoursetype'] = 'Learning Type';
$string['courselearnertype'] = 'Learning Type';
$string['report_externalcertification'] = 'External Certification';
